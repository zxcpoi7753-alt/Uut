/* ============================================================
   ملف: js/custom_logic.js (V26 - مسؤول البيانات فقط)
   تنبيه: هذا الملف تم تنظيفه ليعمل بسلام مع ملفاتك القديمة.
   وظيفته: جلب الأخبار والأوائل من فايربيس فقط.
   ============================================================ */
...
try {
    ...
    db.ref().on('value', (snapshot) => {
        ...
        if (data) {
            ...
            // 3. رسم الجداول والقوائم (التي تأتي من الأدمن)
            ...
            // 5. إخفاء شاشة التحميل (إذا كانت موجودة)
